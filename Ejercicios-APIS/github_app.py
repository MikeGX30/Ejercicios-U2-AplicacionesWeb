...
def obtener_usuario_github(username):
    try:
        ...
        print(f"✅ Datos obtenidos para {username}")
...
def repositorios_trending():
    ...
    try:
        print(f"🔥 Obteniendo repos trending...")
        ...
        print(f"✅ Se encontraron {len(repos)} repos trending")
...
def buscar_repos():
    ...
    try:
        print(f"🔍 Buscando repos: {search_query}")
        ...
        print(f"✅ Se encontraron {len(repos)} repos")
        return jsonify(repos)
...
if __name__ == '__main__':
    print("🐙 GitHub Dashboard - API REST")
    print("⚠️  Límite: 60 requests/hora sin autenticación")
